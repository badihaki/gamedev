...
{/*
    ...
    * 
    * This is the same as PlayerState
    * 
    */
    ...
    /// player obj
    /// </summary>
    protected MechProperties mech;
    protected MechStateMachine stateMachine;
    protected Mecha mechData;
    ...
    public MechState(MechProperties theMech, MechStateMachine theStateMachine, Mecha theData, string theAnimBoolName)
    {
        this.mech = theMech;
        this.stateMachine = theStateMachine;
        this.mechData = theData;
    ...
    {
        DoChecks();
        mech.Anim.SetBool(animBoolName, true);
        startTime = Time.time;
        // Debug.Log("entering mech state: " + stateMachine.CurrentState + " /// animator value: " + animBoolName);
        isAnimationFinished = false;
        isExitingState = false;
    }
    public virtual void Exit()
    {
        mech.Anim.SetBool(animBoolName, false);
        isExitingState = true;
    }
