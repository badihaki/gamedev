...
public class ProtoGrapple : MonoBehaviour
{

    [Header("Scripts Ref:")]
    public ProtoRope grappleRope;
    ...
    {
        /*
        if (controls.AltFireButton == true && controls.TetherCancel == true)
        {
        ...
        else if (controls.TetherCancel == true)
        {
            ...
            else
            {
                ...
                Vector2 mousePos = m_camera.ScreenToWorldPoint(controls.AimInput);
        ...
        else if (controls.AltFireButton == false)
        {
            grappleRope.enabled = false;
            m_springJoint2D.enabled = false;
        ...
        {
            // Vector2 mousePos = m_camera.ScreenToWorldPoint(Input.mousePosition);
            Vector2 mousePos = controls.AimInput;
            RotateGun(mousePos, true);
        }
